// Version of maptiler script without redis, async and adapted for ES6 modules.

// Function taken out of the old async package that follows maptiler.
const until = function (test, iterator, callback) {
  if (!test()) {
...
export default {
  ...
  getTiles: function (left, bottom, right, top, zoom, tileCallback) {
    var mercPos1, mercPos2, westHem, northHem, tilePos1, tilePos2, redis, tiles, tx, ty, testX, testY, addTile, doRow, done, this$ = this;
